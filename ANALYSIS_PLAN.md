...
| Feng & Dubin 2021, *Sci Rep* | eICU, Lasso, variables associated with APACHE IVa **classification errors**; care limitation entered as *frequency of change* | **calibration** not analyzed; no cancer subgroup; limitation level not used |
...
This captures metastatic solid tumor and hematologic malignancy only. Localised
solid tumors are **not** captured, and primary site is unavailable. The cohort is
therefore labeled *metastatic solid tumor or hematologic malignancy*, not "cancer",
...
2. **Decomposition** -- indirect standardization of the cancer SMR to the non-cancer
   code-status distribution. Preliminary: crude 0.869 -> standardized 0.798 against
...
1. Retrospective; 2014-2015 data; US ICUs participating in a tele-ICU program
2. Documentation is not practice -- we observe charting, not decisions or actions
3. Cancer definition excludes localised solid tumors; no primary site
